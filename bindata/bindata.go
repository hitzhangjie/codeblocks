...
func main() {
	...
	tpl := fmt.Sprintf(`// This file is generated by github.com/hitzhangjie/bindata.
// Don't Edit mannually.

// Package bindata stores binary data of the embedded assets into variable %s.
package bindata
